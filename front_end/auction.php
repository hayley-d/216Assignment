...
<head>
    ...
    <link rel="stylesheet" href="../css/auctionRoom.css">
...
<div id="auction-room">
    <div class="heading"><h1 id="auctionName">Auction Name</h1></div>
    <div class="heading"><h2 id="bidAmount">Current Bid: R300 000</h2></div>
    <div class="auction-container" id="auction-container">

        <div class="auction-image" id="image"></div>
        <div class="property-container">
            <div class="property-card">
                <div class="property-title" id="property-title">3 Bedroom Apartment London</div>
                <div class="property-location" id="property-location">London, England</div>
                <div class="property-details">
                    <div id="bed"><div class="bed"></div>5</div>
                    <div id="bath"><div class="bath"></div>2</div>
                    <div id="parking"><div class="parking"></div>0</div>
                </div>

                <div class="property-description" id="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ut fringilla odio.
                ...
                <div class="property-amenities" id="amenities">
...
<div id="auction-code-container">
    <div id="auction-code-form">
        ...
        <button class="submit-btn" onclick="sendCode()">Join Auction</button>
    </div>
</div>
</div>
